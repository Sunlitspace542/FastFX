...
```diff  
-IMPORTANT!-
SHAPED.EXE (the tool used to convert 3DG1/3DAN to BSP) only supports up to 16 frames of animation.
...
## Importing Shapes
Currently, this plugin only supports importing 5 formats:  

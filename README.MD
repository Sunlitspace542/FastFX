# FastFX
A Blender plugin for importing/exporting Fundoshi-kun (Modified Videoscape 3DG1) and ASM BSP/GZS format shapes for use in Star Fox (1/2/EX), with additional tools.  

...
3. CAD/NCA import - wowjinxy's 3ddraw clone rewrite thing is able to read these, add functionality to import them
...
5. Split addon code into separate files - it makes testing take a bit longer, but it makes the code less of a hot mess (can we make a build script to simplify testing?)
